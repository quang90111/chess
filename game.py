...
def redraw_gameWindow(win, bo, p1, p2, color, ready):
    ...
    try:
        txt = font.render(bo.p1Name + "\'s Time: " + str(formatTime2), 1, (255, 255, 0))
        txt2 = font.render(bo.p2Name + "\'s Time: " + str(formatTime1), 1, (255, 255, 0))
    except Exception as e:
        print(e)
    win.blit(txt, (width / 6 - txt.get_width() / 2, 150))
    win.blit(txt2, (width / 6 - txt2.get_width() / 2, height - 100))
    ...
    if not color == "s":
        font = pygame.font.SysFont("comicsans", 30)
        if color == "w":
            txt3 = font.render("YOU ARE", 1, (255, 0, 0))
            win.blit(txt3, (width / 6 - txt3.get_width() / 2, 50))
            txt3 = font.render("WHITE", 1, (255, 0, 0))
            win.blit(txt3, (width / 6 - txt3.get_width() / 2, 100))
        else:
            txt3 = font.render("YOU ARE", 1, (255, 0, 0))
            win.blit(txt3, (width / 6 - txt3.get_width() / 2, 50))
            txt3 = font.render("BLACK", 1, (255, 0, 0))
            win.blit(txt3, (width / 6 - txt3.get_width() / 2, 100))

        if bo.turn == color:
            txt3 = font.render("YOUR TURN", 1, (255, 0, 0))
            win.blit(txt3, (width / 6 - txt3.get_width() / 2, height - 50))
        else:
